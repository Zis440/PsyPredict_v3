        ...
        <div className="grid gap-8">
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              A convolutional neural network (CNN) analyzes facial expressions
              from webcam input to identify core emotions. A rolling emotion
              buffer smooths predictions over time, reducing noise and capturing
              short-term emotional trends rather than isolated frames.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              User text is analyzed using a hybrid NLP pipeline combining
              keyword-based symptom detection, transformer embeddings, and
              structured symptom-to-condition mapping. This allows PsyPredict to
              detect patterns of psychological distress beyond single keywords.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              A large language model generates empathetic, human-readable
              summaries grounded in structured model outputs. Strict guardrails
              prevent diagnosis, medication prescription, or unsafe advice.
            </p>
          </div>
        </div>
      </section>
