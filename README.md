...
![Llama3](https://img.shields.io/badge/LLM-Llama3%20%28Ollama%29-indigo.svg)
...
- **Llama3** via Ollama for structured clinical reasoning (no external API)
...
User Text Input
      ...
      │
      └─► Ollama / Llama3 (local, structured JSON)
...
| **LLM** | Llama3 via Ollama (local, no external API) |
...
│   │   │   └── MEDICATION.csv
│   │   ├── services/
│   │   │   ├── ollama_engine.py       # Llama3 async client
